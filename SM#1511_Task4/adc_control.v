...
always @(negedge adc_sck) begin
   ...
   if(counter == 16) begin
	   counter = 0;
		// update channel
		if(data_frame_reg == 1) d_out_ch7_reg = d_out_chX;
		if(data_frame_reg == 2) d_out_ch5_reg = d_out_chX;
		if(data_frame_reg == 3) d_out_ch6_reg = d_out_chX;
	end
